<x-card class="mb-2 w-1/2">
    <x-card.header>
        ...
        <x-card.description>
            Add new permission into your application.
        </x-card.description>
    </x-card.header>
    <x-card.content>
        <form action="{{ route('permissions.store') }}" method="post">
            ...
            <div>
                ...
                <x-input-error class="mt-2" :messages="$errors->storePermission->get('name')" />
            </div>
            <div class="mt-4">
                ...
                <x-input-error class="mt-2" :messages="$errors->storePermission->get('guard_name')" />
            </div>
